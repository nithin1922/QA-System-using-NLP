...
Original file is located at
    https://colab.research.google.com/drive/1lEkCVoO-aR0luiE4g1eUjuqqmJx-HH1T
"""
...
ax = sns.barplot(x=token_labels[:80], y=start_scores[:80], errorbar=None)
...
#first 100 tokens
plt.rcParams["figure.figsize"] = (20,10)
ax = sns.barplot(x=token_labels[:80], y=end_scores[:80], errorbar=None)
ax.set_xticklabels(ax.get_xticklabels(), rotation=90, ha="center")
ax.grid(True)
